...
Sub GenerateInvoice()
    ...
    Dim tplPath  As String, savePath As String, pdfPath As String
    ...
    ' 1) Launch Word and copy template
    Set wdApp = CreateObject("Word.Application")
    wdApp.Visible = True

    tplPath = ThisWorkbook.Path & "\dev(do not edit)\master_invoice.docx"
    If Dir(tplPath) = "" Then Err.Raise 1001, , "Template missing"
    ...
    MsgBox "Invoice generated:" & vbCrLf & savePath & vbCrLf & pdfPath, vbInformation
